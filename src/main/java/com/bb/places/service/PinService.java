...
public class PinService {
    ...
    // PUT REQUESTS
    @Transactional
    public void updatePin(@NotBlank String id, @Valid Pin pin){
        ...
        rtndPin.setAddress(pin.getAddress());
        rtndPin.setAbout(pin.getAbout());
        rtndPin.setLat(pin.getLat());
        rtndPin.setLng(pin.getLng());
    ...
    // POST REQUESTS
    @Transactional
    public void createPin(@Valid Pin pin){
    ...
    // DELETE REQUESTS
    @Transactional
    public void deletePin(@Valid Pin pin){
