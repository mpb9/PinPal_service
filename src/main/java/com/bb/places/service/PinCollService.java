...
public class PinCollService {
    ...
    public PinColl getPinCollById(@NotBlank String id) {
        ...
        PinColl pinColl = pinCollRepository.findById(id).isPresent() ? pinCollRepository.findById(id).get() : null;

        return pinCollRepository.findById(id).get();
    }

    @Transactional
    public void updatePinColl(@NotBlank String id, @Valid PinColl pinColl){
    ...
    @Transactional
    public void createPinColl(@Valid PinColl pinColl){
    ...
    @Transactional
    public void deletePinColl(@Valid PinColl pinColl){
